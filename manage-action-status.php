                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="block">
                                <label style="font-weight: bold; color: blue; font-size: medium;">NEW ACTION STATUS&nbsp;</label><a href="add-action-status.php"><img title ="Add New Mail" src= "assets/images/add.png" width="30"></a>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="view-action-status.php?id=<?php echo $result->Id; ?>"><img title ="VIEW" src= "assets/images/view.png" width="30"></a>&nbsp;&nbsp;&nbsp;
                                                    <a href="edit-action-status.php?id=<?php echo $result->Id; ?>"><img title ="EDIT" src= "assets/images/edit.png" width="30"></a>&nbsp;&nbsp;&nbsp;
                                                    <a href="delete-action-status.php?delid=<?php echo $result->Id; ?>"><img title ="DELETE" src= "assets/images/delete.png" width="30"></a>
                                                </td>
                                            </tr>
                                            <?php
                                            $cnt = $cnt + 1;
