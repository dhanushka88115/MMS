                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['sch'])) {
                                            if ((strlen($_POST['fdate']) != 0) || (strlen($_POST['tdate']) != 0)) {
                                                $sql = "select * from tblmailmaster where DateStamped>=:nfdate and DateStamped<=:ntdate and IsDeleted='0' ORDER BY DateStamped";
                                                $query = $dbh->prepare($sql);
                                                $query->bindParam(':nfdate', $_POST['fdate'], PDO::PARAM_STR);
                                                $query->bindParam(':ntdate', $_POST['tdate'], PDO::PARAM_STR);
                                            } else {
                                                $sql = "select * from tblmailmaster where IsDeleted='0' ORDER BY DateStamped";
                                                $query = $dbh->prepare($sql);
                                            }
                                        } else {
                                            $sql = "select * from tblmailmaster where IsDeleted='0' ORDER BY DateStamped";
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view-mail-all.php?id=<?php echo $result->Id; ?>"><img title ="POST" src= "assets/images/view.png" width="30"></a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $cnt = $cnt + 1;
